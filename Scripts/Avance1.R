...
barplot(table(data$estado),space = 0.1,col="steelblue",ylim = c(0,260),main = "Censuras y Eventos Observados"
        ,ylab = "Frecuencia absoluta",xlab = "0: censura                     1: Observación")
